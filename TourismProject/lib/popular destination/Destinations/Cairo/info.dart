...
class ExpandedImage extends StatefulWidget {
  ...
  ExpandedImage({required this.imagePath});
              ...
              child: Row(
                children: [
                  Padding(
                    ...
                    child: Center(
                      child: ExpandedImage(imagePath: 'images/cairo1.jpg'),
                    ),
                   ),
                  SizedBox(width: 10),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 16.0),
                    child: Center(
                      child: ExpandedImage(imagePath: 'images/cairo2.jpg'),
                    ),
                   ),
                  SizedBox(width: 10),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 16.0),
                    child: Center(
                      child: ExpandedImage(imagePath: 'images/cairo3.jpg'),
                    ),
                   ),
                ],
              ),
